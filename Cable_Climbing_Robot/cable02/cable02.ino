...
const float distance = 50*10; //- UNIT - mm - change distance which be determined - input() = cm
unsigned long int stop_con_pulse = distance * 220/(65*3.1459);

const int ve = 10;// v - expected - RPM

int T = 10; // determine period of PID 
  ...
  while(true)
  {
    ...
    else
    {
      ...
      //{
        ...
        pulse2a = count2;
        pulse3a = count3;
        float vr1 = (pulse1a - pulse1)*65*1000/(220*T);
        float vr2 = (pulse2a - pulse2)*65*1000/(220*T);
        float vr3 = (pulse3a - pulse3)*65*1000/(220*T);
        E1a = ve - vr1;
        E2a = ve - vr2;
        E3a = ve - vr3;
        ...
        Serial.print("Spring 1:");
        Serial.print(spring01);
        Serial.print("    ");
        Serial.print("Spring 2: ");
        Serial.print(spring02);
        Serial.print("    ");
        Serial.print("Spring 3: ");
        Serial.print(spring03);
        Serial.print("    ");
